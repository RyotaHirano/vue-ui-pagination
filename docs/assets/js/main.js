...
/******/ 	var hotCurrentHash = "e95c576c2dfeb9bee752"; // eslint-disable-line no-unused-vars
...
var store = new _vuex2.default.Store({
  ...
  mutations: {
    ...
    updatePrevIdx: function updatePrevIdx(state) {
      state.prevIdx = state.currentIdx === 0 ? state.images.length - 1 : state.currentIdx - 1;
    },
    updateNextIdx: function updateNextIdx(state) {
      state.nextIdx = state.currentIdx === state.images.length - 1 ? 0 : state.currentIdx + 1;
    },
    setCurrentIdx: function setCurrentIdx(state, id) {
      state.currentIdx = id - 1;
    },
    setIsAnimatePrev: function setIsAnimatePrev(state, TorF) {
      state.isAnimatePrev = TorF;
    },
    setIsAnimateNext: function setIsAnimateNext(state, TorF) {
      state.isAnimateNext = TorF;
    },
    resetIsAnimatePrev: function resetIsAnimatePrev(state) {
      if (state.isAnimatePrev) {
        state.isAnimatePrev = !state.isAnimatePrev;
      }
    },
    resetIsAnimateNext: function resetIsAnimateNext(state) {
      if (state.isAnimateNext) {
        state.isAnimateNext = !state.isAnimateNext;
      }
    },
    updateTouchX: function updateTouchX(state, value) {
      state.touchX = value;
    },
    updateMoveX: function updateMoveX(state, value) {
      state.moveX = value;
    },
    updateIsDrag: function updateIsDrag(state, TorF) {
      state.isDrag = TorF;
    }
  }
});
...
var _carouselView = __webpack_require__(14);
...
exports.default = {
  name: 'app',
  components: {
    carouselView: _carouselView2.default
  }
}; //
//
//
...
exports.default = {
  ...
  methods: {
    ...
    setCurrentIdx: function setCurrentIdx() {
...
var _carouselPagerItem = __webpack_require__(13);

var _carouselPagerItem2 = _interopRequireDefault(_carouselPagerItem);
...
var _carouselItem = __webpack_require__(11);

var _carouselItem2 = _interopRequireDefault(_carouselItem);

var _carouselPager = __webpack_require__(12);
...
exports.default = {
  ...
  computed: {
    ...
    getTotalImages: function getTotalImages() {
  ...
  components: {
    ...
    carouselPager: _carouselPager2.default
  }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "pager-wrapper"
  }, [_c('ul', {
    staticClass: "pager-inner"
  }, _vm._l((_vm.returnStoreImages), function(image, key) {
    return _c('carousel-pager-item', {
      key: key,
      style: ({
        transform: _vm.pagerTranslate
      }),
      attrs: {
        "image": image
      }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('li', {
    ...
    staticClass: "pager-indicator",
    class: _vm.classObjectPagerItem
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    class: _vm.classObjectAnimation,
    style: ({
      transform: _vm.getMoveX
    }),
    on: {
      "mousedown": _vm.startDrag,
      "mousemove": _vm.dragMove,
      "mouseup": _vm.finishDrag,
      "mouseout": _vm.finishDrag,
      "touchstart": _vm.startDrag,
      "touchmove": _vm.dragMove,
      "touchend": _vm.finishDrag,
      "transitionend": _vm.setCurrentIdx
    }
  }, [_c('div', {
    staticClass: "carousel-item carousel-item--prev"
  }, [_c('img', {
    attrs: {
      "src": _vm.getPrevImage(),
      "alt": _vm.getPrevImage('alt')
    }
  })]), _vm._v(" "), _c('div', {
    staticClass: "carousel-item"
  }, [_c('img', {
    attrs: {
      "src": _vm.getCurrentImage(),
      "alt": _vm.getCurrentImage('alt')
    }
  })]), _vm._v(" "), _c('div', {
    staticClass: "carousel-item carousel-item--next"
  }, [_c('img', {
    attrs: {
      "src": _vm.getNextImage(),
      "alt": _vm.getNextImage('alt')
    }
  })])])
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "images": _vm.returnStoreImages,
      "totalImageNum": _vm.getTotalImages
    }
  })], 1), _vm._v(" "), _c('div', {
    staticClass: "carousel-pager"
  }, [_c('carousel-pager')], 1)])
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "section"
  }, [_c('h1', [_vm._v("Vue Carousel")]), _vm._v(" "), _c('carousel-view')], 1)])
},staticRenderFns: []}
